...
//            sigmas[i] = sortedDistances[Integer.parseInt(knn_neighbour)];
    ...
    public static void main(String[] args) throws IOException {
        ...
        String dataPath = "D:/de/MASTER_THESIS/Decision-Tree-Neo4j/java-plugin/src/main/resources/test.csv";
        String dataPath1 = "D:/de/MASTER_THESIS/SimKit/simkit/data/dataset_1_iris_numeric/Iris_Mythica_Data_Set.csv";

...
public class DistanceMeasureNodes {
    ...
    public static Double[][] manhattanDistance(List<NodeList2> nodeList){
        int size = nodeList.size();
        Double[][] distanceMatrix = new Double[size][size];

        for (int i = 0; i < size; i++) {
            for (int j = 0; j < size; j++) {
                    double distance = calculateManhattanDistance(nodeList.get(i), nodeList.get(j));
                    distanceMatrix[i][j] = distance;
            }
        }
        return distanceMatrix;
    }
    private static double calculateManhattanDistance(NodeList2 node1, NodeList2 node2) {
        Map<String, Object> properties1 = node1.getProperties();
        Map<String, Object> properties2 = node2.getProperties();
    ...
    public static Double[][] canberraDistance(List<NodeList2> nodeList){
        int size = nodeList.size();
        Double[][] distanceMatrix = new Double[size][size];

        for (int i = 0; i < size; i++) {
            for (int j = 0; j < size; j++) {
                    double distance = calculateCanberraDistance(nodeList.get(i), nodeList.get(j));
                    distanceMatrix[i][j] = distance;
            }
        }
        return distanceMatrix;
    }
    private static double calculateCanberraDistance(NodeList2 node1, NodeList2 node2) {
        Map<String, Object> properties1 = node1.getProperties();
        Map<String, Object> properties2 = node2.getProperties();
    ...
    public static Double[][] cosineSimilarity(List<NodeList2> nodeList){
        int size = nodeList.size();
        Double[][] distanceMatrix = new Double[size][size];
        ...
        for (int i = 0; i < size; i++) {
            for (int j = i; j < size; j++) {
                    ...
                    double distance = calculateCosineSimilarity(nodeList.get(i), nodeList.get(j));
                    distanceMatrix[i][j] = distance;
    ...
    private static double calculateCosineSimilarity(NodeList2 node1, NodeList2 node2) {
        Map<String, Object> properties1 = node1.getProperties();
        Map<String, Object> properties2 = node2.getProperties();
    ...
    public static Double[][] jaccardCoefficient(List<NodeList2> nodeList){
        int size = nodeList.size();
        Double[][] distanceMatrix = new Double[size][size];
        ...
        for (int i = 0; i < size; i++) {
            for (int j = i; j < size; j++) {
                    ...
                    double distance = calculateJaccardCoefficient(nodeList.get(i), nodeList.get(j));
                    distanceMatrix[i][j] = distance;
                    distanceMatrix[j][i] = distance;
            }
        }
    ...
    private static double calculateJaccardCoefficient(NodeList2 node1, NodeList2 node2) {
        Map<String, Object> properties1 = node1.getProperties();
        Map<String, Object> properties2 = node2.getProperties();
    ...
    public static Double[][] brayCurtisDistance(List<NodeList2> nodeList){
        int size = nodeList.size();
        Double[][] distanceMatrix = new Double[size][size];
        ...
        for (int i = 0; i < size; i++) {
            for (int j = i; j < size; j++) {
                    ...
                    double distance = calculateBrayCurtisDistance(nodeList.get(i), nodeList.get(j));
                    distanceMatrix[i][j] = distance;
                    distanceMatrix[j][i] = distance;
            }
        }
    ...
    private static double calculateBrayCurtisDistance(NodeList2 node1, NodeList2 node2) {
Map<String, Object> properties1 = node1.getProperties();
        Map<String, Object> properties2 = node2.getProperties();
